...
const LIVE_CAMS = [
  ...
  // ═══════════════════════════════════════════════════
  {
    id: 'bourbon-street-live',
    name: 'Bourbon Street Live',
    location: 'New Orleans, LA',
    category: 'urban',
    coords: [-90.0671, 29.9584],
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCYgx6jMhRLP83mlcIF3dEdw&autoplay=1&mute=1',
    fallback: 'https://www.earthcam.com/usa/louisiana/neworleans/bourbonstreet/',
  },
  {
    ...
    location: 'New Orleans, LA',
    category: 'urban',
    coords: [-90.0648, 29.9587],
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCH2MByIPSFmMbeMfAv7GkWw&autoplay=1&mute=1',
    fallback: 'https://www.earthcam.com/usa/louisiana/neworleans/bourbonstreet/',
  },
  {
    id: 'nola-jackson-square',
    name: 'Jackson Square',
    location: 'New Orleans, LA',
    category: 'urban',
    coords: [-90.0633, 29.9576],
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCTzUHj8Rwg0qE2Y1Y8cFhqA&autoplay=1&mute=1',
    fallback: 'https://www.earthcam.com/usa/louisiana/neworleans/',
  },
  {
    id: 'nola-canal-street',
    name: 'Canal Street',
    location: 'New Orleans, LA',
    category: 'urban',
    coords: [-90.0701, 29.9529],
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCE_kDl1cweYAPgBpMPcq1Cg&autoplay=1&mute=1',
    fallback: null,
  },

  // ═══════════════════════════════════════════════════
  // MORE KENSINGTON / PHILADELPHIA
  // ═══════════════════════════════════════════════════
  {
    id: 'kensington-philly-3',
    name: 'Kensington Ave Walk',
    location: 'Philadelphia, PA',
    category: 'urban',
    coords: [-75.1310, 39.9955],
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCyDfaLZjAadVHBNfQVo6QSw&autoplay=1&mute=1',
    fallback: 'https://worldcams.tv/united-states/philadelphia/kensington-avenue',
  },
  {
    id: 'kensington-philly-4',
    name: 'Kensington & Somerset',
    location: 'Philadelphia, PA',
    category: 'urban',
    coords: [-75.1295, 39.9930],
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCQZ6a2THlSIeT2RcuMPkVQ&autoplay=1&mute=1',
    fallback: 'https://worldcams.tv/united-states/philadelphia/kensington-avenue',
  },
  {
    id: 'philly-city-hall',
    ...
    location: 'Philadelphia, PA',
    category: 'urban',
    coords: [-75.1636, 39.9526],
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCWjzyf3mGQ5NVphjGR13emw&autoplay=1&mute=1',
    fallback: null,
  },

  // ═══════════════════════════════════════════════════
  // MORE WARZONE / CONFLICT CAMS
  // ═══════════════════════════════════════════════════
  {
    id: 'israel-haifa',
    name: 'Haifa Port & Bay',
    ...
    category: 'conflict',
    coords: [35.0013, 32.8191],
    embed: 'https://www.skylinewebcams.com/en/webcam/israel/haifa/haifa/haifa.html',
    fallback: 'https://worldcam.eu/webcams/asia/israel',
  },
  {
    id: 'israel-eilat',
    name: 'Eilat Red Sea',
    ...
    embed: 'https://www.skylinewebcams.com/en/webcam/israel/eilat/eilat/eilat.html',
    fallback: 'https://worldcam.eu/webcams/asia/israel',
  },
  {
    id: 'mashhad-shrine',
    ...
    category: 'conflict',
    coords: [59.6168, 36.2605],
    embed: 'https://www.skylinewebcams.com/en/webcam/iran/razavi-khorasan/mashhad/imam-reza-shrine.html',
    fallback: 'https://www.iplivecams.com/live-cams/mashhad-iran/',
  },
  {
    id: 'tehran-city',
    name: 'Tehran Skyline',
    ...
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCWN_JmFVkOS-V5RdTi-gbVA&autoplay=1&mute=1',
    fallback: 'https://www.iplivecams.com/live-cams-countries/iran/',
  },

  // ═══════════════════════════════════════════════════
  // IRAN / ISRAEL WAR — VERIFIED LIVE MULTICAMS
  // ═══════════════════════════════════════════════════
  {
    id: 'iran-israel-multicam',
    name: 'Iran-Israel Multi-Cam OSINT',
    location: 'Tehran, Isfahan, Tel Aviv +',
    category: 'conflict',
    coords: [51.39, 35.69],
    embed: 'https://www.youtube.com/embed/4GxCZTnf2Qc?autoplay=1&mute=1',
    fallback: 'https://en.camerasdomundo.com/israel-vs-iran-live/',
  },
  {
    id: 'iran-israel-ceasefire-cam',
    name: 'Middle East Multi-Cam Live',
    location: 'Israel / Iran Theater',
    category: 'conflict',
    coords: [34.78, 32.08],
    embed: 'https://www.youtube.com/embed/9kJk4fSnyYk?autoplay=1&mute=1',
    fallback: 'https://en.camerasdomundo.com/israel-vs-iran-live/',
  },

  // Isfahan — Direct IP cam streams (Axis MJPEG)
  {
    id: 'isfahan-citycenter-1',
    name: 'Isfahan City Center Mall',
    location: 'Isfahan, Iran',
    category: 'conflict',
    coords: [51.6550, 32.6546],
    embed: 'http://185.72.27.245:8004/axis-cgi/mjpg/video.cgi',
    fallback: 'https://www.iplivecams.com/live-cams/isfahan-iran/',
  },
  {
    id: 'isfahan-citycenter-2',
    name: 'Isfahan Financial Center',
    location: 'Isfahan, Iran',
    category: 'conflict',
    coords: [51.6580, 32.6520],
    embed: 'http://185.72.27.245:8003/axis-cgi/mjpg/video.cgi',
    fallback: 'https://www.iplivecams.com/live-cams/isfahan-iran/',
  },

  // ═══════════════════════════════════════════════════
  // UKRAINE — VERIFIED YOUTUBE IDs (from zvamy.org)
  // ═══════════════════════════════════════════════════
  {
    id: 'ukraine-sumy-fountain',
    name: 'Sumy - Fontain Sadko',
    location: 'Sumy, Ukraine',
    category: 'conflict',
    coords: [34.7981, 50.9077],
    embed: 'https://www.youtube.com/embed/gGbZ6RvJeFE?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-sumy-panorama',
    name: 'Sumy - City Panorama',
    location: 'Sumy, Ukraine',
    category: 'conflict',
    coords: [34.8010, 50.9100],
    embed: 'https://www.youtube.com/embed/XcDFb1bOIQQ?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-sumy-3',
    name: 'Sumy Street View',
    location: 'Sumy, Ukraine',
    category: 'conflict',
    coords: [34.7950, 50.9050],
    embed: 'https://www.youtube.com/embed/thJobzSn7kI?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-odesa-1',
    name: 'Odesa City View 1',
    location: 'Odesa, Ukraine',
    category: 'conflict',
    coords: [30.7233, 46.4825],
    embed: 'https://www.youtube.com/embed/5hHelJALhEo?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-odesa-2',
    name: 'Odesa City View 2',
    location: 'Odesa, Ukraine',
    category: 'conflict',
    coords: [30.7280, 46.4850],
    embed: 'https://www.youtube.com/embed/E3q6i5mGr40?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-odesa-3',
    name: 'Odesa Port Area',
    location: 'Odesa, Ukraine',
    category: 'conflict',
    coords: [30.7350, 46.4800],
    embed: 'https://www.youtube.com/embed/BlywGRXC1B0?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-odesa-4',
    ...
    location: 'Odesa, Ukraine',
    category: 'conflict',
    coords: [30.7400, 46.4780],
    embed: 'https://www.youtube.com/embed/Z6O-6UfpGow?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-kyiv-skyline-2',
    name: 'Kyiv Skyline 2',
    location: 'Kyiv, Ukraine',
    category: 'conflict',
    coords: [30.5200, 50.4560],
    embed: 'https://www.youtube.com/embed/CqglJ0XSJ-0?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-kyiv-maidan-3',
    name: 'Kyiv Maidan (Alt)',
    location: 'Kyiv, Ukraine',
    category: 'conflict',
    coords: [30.5234, 50.4510],
    embed: 'https://www.youtube.com/embed/uJ6AzlYCysY?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-kyiv-euro-sq-2',
    name: 'Kyiv European Square (Alt)',
    location: 'Kyiv, Ukraine',
    category: 'conflict',
    coords: [30.5281, 50.4485],
    embed: 'https://www.youtube.com/embed/RMhWl3yPdDw?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-kyiv-3',
    name: 'Kyiv City View 3',
    location: 'Kyiv, Ukraine',
    category: 'conflict',
    coords: [30.5180, 50.4520],
    embed: 'https://www.youtube.com/embed/37DgsbEJNas?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-severodonetsk-2',
    name: 'Severodonetsk 2',
    location: 'Luhansk Oblast, Ukraine',
    category: 'conflict',
    coords: [38.4930, 48.9500],
    embed: 'https://www.youtube.com/embed/Ho40J7dRlGQ?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-mykolaiv-naberezhna',
    name: 'Mykolaiv Naberezhna Walk',
    location: 'Mykolaiv, Ukraine',
    category: 'conflict',
    coords: [32.0020, 46.9710],
    embed: 'https://www.youtube.com/embed/vKDNIAb7RfU?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-mykolaiv-4',
    name: 'Mykolaiv View 4',
    location: 'Mykolaiv, Ukraine',
    category: 'conflict',
    coords: [31.9960, 46.9720],
    embed: 'https://www.youtube.com/embed/nA1yyjVTzzA?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-nemico-multi',
    name: 'Nemico Network Multi-Cam',
    location: 'Multiple Cities, Ukraine',
    category: 'conflict',
    coords: [30.52, 50.45],
    embed: 'https://www.youtube.com/embed/jNZM_H6q1rY?autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },
  {
    id: 'ukraine-lviv-truskavets',
    name: 'Truskavets',
    location: 'Lviv Oblast, Ukraine',
    category: 'conflict',
    coords: [23.5054, 49.2784],
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCaZhEeRxAKQpNEpU8J3wEVw&autoplay=1&mute=1',
    fallback: 'https://zvamy.org/live-webcams-ukraine/',
  },

  // ═══════════════════════════════════════════════════
  // MORE GLOBAL URBAN / INTERESTING
  // ═══════════════════════════════════════════════════
  {
    ...
    category: 'urban',
    coords: [-80.1300, 25.7826],
    embed: 'https://www.youtube.com/embed/live_stream?channel=UC8v3tmS_3pc2PR5MRFQhfEA&autoplay=1&mute=1',
    fallback: 'https://www.earthcam.com/usa/florida/miamibeach/',
  },
  {
    id: 'chicago-skyline',
    ...
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCd9aKo_-UBUymzAhiLj99LA&autoplay=1&mute=1',
    fallback: null,
  },
  {
    ...
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCTjsZhtWhBCVDkMfaIXkHkQ&autoplay=1&mute=1',
    fallback: null,
  },
  {
    ...
    category: 'urban',
    coords: [-86.7743, 36.1619],
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCGLBbMxoPVXGMR5Gpw2fRLQ&autoplay=1&mute=1',
    fallback: null,
  },
  {
    id: 'key-west-duval',
    ...
    category: 'urban',
    coords: [-81.8023, 24.5551],
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCJsGKxb1kMhYz_2bADX80lA&autoplay=1&mute=1',
    fallback: null,
  },
  {
    id: 'istanbul-galata',
    ...
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCx0Yp-C3Vm4n1R-0u3GfvUg&autoplay=1&mute=1',
    fallback: 'https://worldcams.tv/turkey/istanbul/galata-tower',
  },
  {
    id: 'mumbai-gateway',
    ...
    embed: 'https://www.youtube.com/embed/live_stream?channel=UC-TfALVKR_5qN8oHV4Srlvg&autoplay=1&mute=1',
    fallback: null,
  },
  {
    id: 'singapore-marina',
    ...
    location: 'Singapore',
    category: 'urban',
    coords: [103.8586, 1.2839],
    embed: 'https://www.youtube.com/embed/live_stream?channel=UCvJGDC_bB4oKsj2oFMRAqhA&autoplay=1&mute=1',
    fallback: 'https://worldcams.tv/singapore/marina-bay-sands',
  },
];
...
// Domains that block iframe embedding (X-Frame-Options: SAMEORIGIN)
const BLOCKED_EMBED_DOMAINS = ['skylinewebcams.com', 'earthcam.com', 'earthtv.com'];

function isEmbedBlocked(url) {
  if (!url) return true;
  // Block non-HTTPS (MJPEG IP cams, etc) — iframes can't load mixed content
  if (url.startsWith('http://')) return true;
  try { return BLOCKED_EMBED_DOMAINS.some(d => new URL(url).hostname.includes(d)); }
  catch { return false; }
}

function getDirectUrl(cam) {
  const embed = cam.embed || '';
  if (embed.includes('youtube') && embed.includes('/embed/live_stream')) {
    const ch = embed.match(/channel=([^&]+)/);
    if (ch) return `https://www.youtube.com/channel/${ch[1]}/live`;
  }
  if (embed.includes('youtube') && embed.includes('/embed/')) {
...
// YouTube live_stream embeds almost always block iframe embedding (error 153).
// Detect these and skip straight to a direct link instead of a black iframe.
function isYoutubeLiveStream(url) {
  return url && url.includes('youtube') && url.includes('/embed/live_stream');
}
...
function openCamPlayer(cam) {
  ...
  const blockedEl = playerEl.querySelector('.cam-player-blocked');
  ...
  const blocked = isEmbedBlocked(cam.embed);
  const ytLive = isYoutubeLiveStream(cam.embed);
  const directUrl = getDirectUrl(cam);

  // YouTube live streams: skip iframe (will always get 153 error), show direct link
  if (ytLive) {
    if (iframeEl) { iframeEl.src = 'about:blank'; iframeEl.style.display = 'none'; }
    if (blockedEl) {
      blockedEl.innerHTML =
        `<div style="text-align:center;padding:20px 10px;">` +
        `<div style="font-size:11px;color:rgba(200,220,240,0.7);margin-bottom:12px;letter-spacing:1px;">LIVE STREAM — OPEN IN YOUTUBE</div>` +
        `<a href="${directUrl}" target="_blank" rel="noopener" style="display:inline-block;font-family:'JetBrains Mono',monospace;font-size:12px;letter-spacing:2px;color:#ff4444;background:rgba(255,68,68,0.15);border:1px solid rgba(255,68,68,0.5);padding:10px 24px;border-radius:3px;text-decoration:none;font-weight:700;transition:all 0.15s;">` +
        `WATCH LIVE &#9654;</a>` +
        (cam.fallback ? `<br><a href="${cam.fallback}" target="_blank" rel="noopener" style="display:inline-block;margin-top:10px;font-size:10px;color:rgba(200,220,240,0.5);text-decoration:none;letter-spacing:1px;">ALTERNATE SOURCE &#8599;</a>` : '') +
        `</div>`;
    ...
    // Non-YouTube blocked domains (skylinewebcams etc)
    if (iframeEl) { iframeEl.src = 'about:blank'; iframeEl.style.display = 'none'; }
    if (blockedEl) {
      const link = cam.embed || cam.fallback || '#';
      blockedEl.innerHTML =
        `<div style="text-align:center;padding:20px 10px;">` +
        `<div style="font-size:11px;color:rgba(200,220,240,0.7);margin-bottom:12px;letter-spacing:1px;">EMBEDDING BLOCKED BY SOURCE</div>` +
        `<a href="${link}" target="_blank" rel="noopener" style="display:inline-block;font-family:'JetBrains Mono',monospace;font-size:12px;letter-spacing:2px;color:#00CED1;background:rgba(0,206,209,0.12);border:1px solid rgba(0,206,209,0.5);padding:10px 24px;border-radius:3px;text-decoration:none;font-weight:700;">OPEN ON SOURCE SITE &#8599;</a>` +
        `</div>`;
      blockedEl.style.display = '';
    }
    if (directEl) directEl.style.display = 'none';
    if (fallbackEl) fallbackEl.style.display = 'none';
  } else if (cam.embed && cam.embed.includes('youtube')) {
    // YouTube video embed — try iframe but also show direct link in case of 153
    if (iframeEl) { iframeEl.src = cam.embed; iframeEl.style.display = ''; }
    if (blockedEl) blockedEl.style.display = 'none';
    if (directEl) { directEl.href = directUrl; directEl.textContent = 'WATCH ON YOUTUBE'; directEl.style.display = ''; }
    if (fallbackEl) {
    ...
    // Non-YouTube embeddable source
    if (iframeEl) { iframeEl.src = cam.embed; iframeEl.style.display = ''; }
    if (blockedEl) blockedEl.style.display = 'none';
    if (directEl) { directEl.href = directUrl; directEl.style.display = ''; }
    if (fallbackEl) {
      if (cam.fallback && cam.fallback !== directUrl) {
        fallbackEl.href = cam.fallback;
        fallbackEl.style.display = '';
