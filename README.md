...
- **Click any aircraft** to open a full detail panel with altitude, speed, heading, vertical rate, squawk, ICAO hex, ADS-B category, VIP/military badges, and more
...
- **Conflict zones** — highlighted regions for active conflicts (Ukraine, Gaza/Israel, Iran/Epic Fury, Sudan, Myanmar) with click-for-details popup explaining each conflict
- **Iran theater intelligence** — Operation Epic Fury / Roaring Lion briefing panel with verified strike locations, casualty tracking, GDELT real-time news feed, Strait of Hormuz blockade overlay, and affected airport status
